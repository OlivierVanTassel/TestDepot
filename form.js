...
function sendContact() {
    ...
    if (isValid()) {
        let usr + new User(firstName.value, lastName.value, feilds.gender.value, address.value, country.value, email.value, newsletter.checked);

        alert(`${usr.firstName} merci de vous êtres inscrits.`)
